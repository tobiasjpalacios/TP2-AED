...
while opcion != 4:
    ...
    if opcion == 1:
        ...
        # TIMER CON CARGA ---> AUTMATICA <---
            ...
            v1 = random.choice(numeros)
            v2 = random.choice(numeros)
            v3 = random.choice(numeros)


            patentet1 = L1 + L2 + L3 + v1 + v2 + v3
            patentet2 = L1 + L2 + v1 + v2 + v3 + L3 + L4

            patentes_r = L1 + L2 + L3 + v1 + v2 + v3, L1 + L2 + v1 + v2 + v3 + L3 + L4
            ...
            while (ahora < fin):
                ...
                # Telepeaje...
                #VALIDACION
                patente = random.choice(patentes_r)
                if forma_pago == 2 and tipo == 1:
